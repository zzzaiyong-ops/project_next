...
function renderReports(){
  ...
  document.getElementById('rep-tbl').innerHTML = rows ||
    '<tr><td colspan="12" class="empty" style="padding:32px;text-align:center;color:var(--text3)">해당 조건의 캠페인이 없습니다</td></tr>';
  // 전체선택 체크박스 동기화
  ...
  if(type==='products'){
    ...
    ws=XLSX.utils.json_to_sheet(selectedCamps.map(function(c){
      ...
      return {캠페인명:c.name,규모:c.infSize||c.role||'',MDCAT:c.mdcat||'',카테고리:c.cat||'',
        ...
        인플루언서수수료:infFee,원고료:feeAmt,에이전시수수료:agFee,DA광고료:daFee,
