...
function exportS7ExcelFiltered(camps){
  ...
  var ws = {};
  ws['!cols'] = [{wch:14},{wch:22},{wch:14},{wch:14},{wch:11},{wch:10},{wch:13},{wch:10},{wch:11},{wch:11},{wch:18},{wch:12},{wch:20},{wch:20},{wch:18},{wch:18},{wch:22},{wch:11},{wch:10},{wch:12},{wch:24}];
  var R = 0;
  hdrs.forEach(function(h,ci){
    ws[XLSX.utils.encode_cell({r:R,c:ci})] = {v:h,t:'s',s:hdStyle};
  });
  camps.forEach(function(c){
